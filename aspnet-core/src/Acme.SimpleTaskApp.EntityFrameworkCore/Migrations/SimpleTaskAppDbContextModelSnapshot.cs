...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.Developer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DeveloperCommits")
                        .HasColumnType("int");

                    b.Property<string>("DeveloperName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeveloperSide")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.DeveloperAlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeveloperAlani")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("DeveloperAlani", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.Gorev", b =>
                {
                    ...
                    b.Property<DateTime>("BitirmeZamani")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("DeveloperNot")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.GorevDurum", b =>
                {
                    ...
                    b.ToTable("GorevDurum", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.MusteriIstek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DegistirmeTarih")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("MusteriIstek", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.ProjeDurum", b =>
                {
                    ...
                    b.ToTable("ProjeDurum", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.ProjeYonetici", b =>
                {
                    ...
                    b.Property<string>("ProjeYoneticisiAdi")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ProjeYoneticisi", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.Developer", b =>
                {
                    b.HasOne("Acme.SimpleTaskApp.Projeler.Proje", "Proje")
                        .WithMany()
                    ...
                    b.HasOne("Acme.SimpleTaskApp.Projeler.ProjeYonetici", "Yonetici")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.Gorev", b =>
                {
                    b.HasOne("Acme.SimpleTaskApp.Projeler.Developer", "Developer")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Projeler.Proje", b =>
                {
                    ...
                    b.HasOne("Acme.SimpleTaskApp.Projeler.ProjeYonetici", "ProjeYoneticisi")
                        .WithMany()
                        .HasForeignKey("ProjeYoneticisiId");

                    b.Navigation("Musteri");

                    b.Navigation("ProjeYoneticisi");
                });
